...
age = st.sidebar.number_input('Age (Range 15 - 25)')
...
absences = st.sidebar.number_input('Absences (Range 0 - 80)')
Fedu = st.sidebar.number_input("Father's Education (Range 0 - 4)")
studytime = st.sidebar.number_input('Studytime')
Medu = st.sidebar.number_input("Mother's Education (Range 0 - 4)")
